	...
	public String update() throws Exception  {
		...
		if(stat==1) {
			if(adm==null){//如果没有账号（那也就没有店铺）就新增账号和店铺
				...
				String fun = ",myshop,coupon,couponadd,couponedit,coupondel,myseckill,stafflist,staffedit,staffadd,category,categoryadd,categoryedit,categorydel,product,padd,pedit,pdel,inventory,inventoryadd,comment,commentedit,order,orderedit,ordercall,refund,refundedit,kefuim,";
