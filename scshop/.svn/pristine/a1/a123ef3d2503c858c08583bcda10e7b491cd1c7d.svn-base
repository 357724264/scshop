...
public class Const {
	...
	public static final String BASE_URL = "m.123mfl.com";
	public static final String CACHE_SECKILL_LOCK = "cache_seckill_lock_";
	public static final int FRONT_PAGE_SIZE = 10;
	public static final int BACK_PAGE_SIZE = 10;
	public static String WEBINFO_ID = "1";
	public static String BASEURL = "m.123mfl.com";
	...
	public static final String EXPRESSAGE_CALLBACK_URL = "http://m.123mfl.com/callback.action";// 快递信息的回调URL
	public static final String EXPRESSAGE_KEY = "dLrQVygT9205";// 快递查询的授权码
	public static final String EXPRESSAGE_REQUEST_URL = "http://www.kuaidi100.com/poll";// 快递查询的订阅URL
	// 融云相关
	public static String RONGCLOUD_KEY = "qd46yzrf47p6f";
	public static String RONGCLOUD_SECRET = "Yw80PA8V3aGW";
	// 信鸽相关
	// 推送的时候，绑定的用户名的前缀
	public static String PUSH_ADMIN_FORNT = "A00000000";
	
	public static String PUSH_USER_FORNT = "U00000000";
	public static long XG_APPID = 2100182957;
	public static String XG_SECRET_KEY = "8c3b2bb33ab73aedc10b3fb94f3ec764";
	public static String DEFAULT_KEFU_PHOTO = "http://static.123mfl.com/kefu.jpg";
	public static String DEFAULT_CUSTOMER_PHOTO = "http://static.123mfl.com/customer.jpg";
