...
import com.wudianyi.wb.scshop.util.RandomStringGenerator;
...
public class WxPayReqData {
	 ...
	 */
	public WxPayReqData(String appid, String mchid, String body, String attach,
			String outTradeNo, int totalFee, String spBillCreateIP,
			String timeStart, String timeExpire, String notify_url,
			String openid, String key, String trade_type) {
		...
		// 根据API给的签名规则进行签名
		String sign = WxSignature.getSign(toMap(), key);
