...
public class LoginAction extends BaseAction {
	...
	public String in() {
		...
		jsonObject.put("username", customer.getName()==null?"用户"+customer.getId():customer.getName());
		jsonObject.put("pic", customer.getPic());
	...
	public String check(){
		...
		if(userid == null) {
			retObject.put("login", false);
		}else {
			retObject.put("login", true);
		}
