...
public class OrderAction extends BaseAction {
	...
	public String send() throws Exception {
		...
		if(binding==1) {
			QueryParam params = new QueryParam().add("postNum", no).add("del", 0);
			int totalCount = orderService.getTotalCount(params, false);
			if(totalCount>0) {
				subscribe = false;
			}
		}
...
//			req.getParameters().put("callbackurl", "http://58.61.184.15:9999/callback.action");
