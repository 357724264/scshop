    ...
    n = {
        ...
        onChange: function(a, c, d) {
            ...
            return h !== k ? (clearTimeout(b), void(b = setTimeout(function() {
                ...
                g = b[0];
                var c = f(h, g);
                a.cols[1].replaceValues(b),
                a.cols[2].replaceValues(c),
                k = h,
                l = g,
                a.updateValue()
            },
    ...
    a.fn.cityPicker = function(b) {
        return this.each(function() {
            if (this) {
                var c = a.extend(n, b),
                d = a(this).val();
                d && (c.value = d.split(" "), c.value[0] && (k = c.value[0], c.cols[1].values = e(c.value[0])), c.value[1] ? (l = c.value[1], c.cols[2].values = f(c.value[0], c.value[1])) : c.cols[2].values = f(c.value[0], c.cols[1].values[0]), c.value[2] && (m = c.value[2])),
                a(this).picker(c)
            }
        })
    }
