...
var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{
	...
	function cmbAddOption(cmb, str, obj)
	{
		...
		if(str == "请选择省份" || str == "请选择城市" || str == "请选择区域"){
			option.value = '';
		}else{
			option.value = str;
		}
...
{name:'重庆', cityList:[           
{name:'重庆市', areaList:['江津区','合川区','永川区','南川区','万州区','涪陵区','渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','万盛区','双桥区','渝北区','巴南区','黔江区','长寿区','綦江县','潼南县','铜梁县','大足县','荣昌县','璧山县','梁平县','城口县','丰都县','垫江县','武隆县','忠　县','开　县','云阳县','奉节县','巫山县','巫溪县','石柱土家族自治县','秀山土家族苗族自治县','酉阳土家族苗族自治县','彭水苗族土家族自治县']} 
]},  
{name:'四川', cityList:[           
...
{name:'深圳市', areaList:['市辖区','罗湖区','福田区','南山区','宝安区','龙华新区','龙岗区','盐田区']},          
...
{name:'香港', cityList:[
{name:'香港市', areaList:['中西区','东区','九龙城区','观塘区','南区',"深水区","湾仔区","黄大仙区","油尖旺区","离岛区","葵青区","北区","西贡区","沙田区","屯门区","大埔区","荃湾区","元朗区"]}
]},  
{name:'澳门', cityList:[
{name:'澳门市', areaList:['花地玛堂区','圣安多尼堂区','大堂区','望德堂区','风顺堂区',"嘉模堂区","圣方济各堂区"]}
]}  
];  