					...
					<tr>
						...
						-->					
							...
							<#if functionitems?index_of(",member,") gte 0>
								<div class="qxbox">
									<label class='qxlabel'><input class="checkall"type="checkbox" value="member"/>会员等级管理</label>
									<#if functionitems?index_of(",memberadd,") gte 0>
										<label class='qxlabel'><input name="qxipt" type="checkbox" disabled="disabled" value="memberadd"/>新增等级</label>
									</#if>
									<#if functionitems?index_of(",memberedit,") gte 0>
										<label class='qxlabel'><input name="qxipt" type="checkbox" disabled="disabled" value="memberedit"/>编辑等级</label>
									</#if>
									<#if functionitems?index_of(",memberdel,") gte 0>
										<label class='qxlabel'><input name="qxipt" type="checkbox" disabled="disabled" value="memberdel"/>删除等级</label>
									</#if>
								</div>
							</#if>
							...
							<#if functionitems?index_of(",ceskill,") gte 0>
								<div class="qxbox">
									<label class='qxlabel'><input class="checkall" type="checkbox" value="ceskill"/>优惠活动管理</label>
									<#if functionitems?index_of(",seckilledit,") gte 0>
										<label class='qxlabel'><input name="qxipt" type="checkbox" disabled="disabled" value="seckilledit"/>优惠活动审核</label>
									</#if>
								</div>
							</#if>
							...
							<#if functionitems?index_of(",refund,") gte 0>
								<div class="qxbox">
									<label class='qxlabel'><input class="checkall" type="checkbox" value="refund"/>退款审核管理</label>
									<#if functionitems?index_of(",refundedit,") gte 0>
										<label class='qxlabel'><input name="qxipt" type="checkbox" disabled="disabled" value="refundedit"/>退款审核操作</label>
									</#if>
								</div>
							</#if>
							...
							<#if functionitems?index_of(",myseckill,") gte 0>
								<div class="qxbox">
									<label class='qxlabel'><input class="checkall" type="checkbox" value="myseckill"/>我的优惠活动</label>
								</div>
							</#if>
					...
					<tr>
						...
						<td>
							<#if functionitems?index_of(",ordercall,") gte 0>
								<div class="qxbox2">
									<label class='qxlabel'><input class="checkall" type="checkbox" value="ordercall"/>新订单提醒<font color="#FF0000">(提醒以短信形式发送,请设置正确的手机号码。)</font></label>
								</div>
							</#if>
						</td>
					...
					<tr>
						...
						<td>
							<#if functionitems?index_of(",kefuim,") gte 0>
								<div class="qxbox2">
									<label class='qxlabel'><input class="checkall" type="checkbox" value="kefuim"/>客服聊天</label>
								</div>
							</#if>
						</td>
					</tr>
