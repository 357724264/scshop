...
<div class="dialog dialog_extend dialog_cash" style="height:466px;">
	...
	<div class="dialog_body">
			<table cellspacing="0" cellpadding="0" width="80%" class="dia_table">
				...
				<tr>
					<td class="dia_ltd">订单捆绑：</td>
					<td>
						<select class="dia_select" id="binding">
							<option value="0">正常</option>
							<option value="1">捆绑</option>
						</select>
					</td>
				</tr>
				<tr>
					<td class="dia_ltd">快递单号：</td>
					<td><input placeholder="请填写快递单号" type="text" class="dia_inp" id="no" name="no" value="${(order.postNum)!}">
	...
	$(function(){
		...
		$("#kdsure").bind("click",function(){
			...
			$.ajax({
				...
				data:{binding:binding,cc:cc,no:no,id:"${id}"<#if order.payStat==1>,tt:"1"</#if>},
				type:"post",
